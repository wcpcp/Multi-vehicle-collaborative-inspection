...
class OdometryNode:
    ...
    def sub_robot_pose_update(self, msg):
        ...
        try:
            arrayIndex = msg.name.index(robot_name+'::base_link')
    ...
    def timer_callback(self, event):
        ...
        cmd.header.frame_id =robot_name+ '/odom'
        cmd.child_frame_id = robot_name+'/base_link'
...
if __name__ == '__main__':
    ...
    # rospy.loginfo('                                                                        Get param1 = %s   ', robot_name)
    node = OdometryNode()
    rospy.spin()
